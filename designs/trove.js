...
const DESIGN_TROVE = {
  ...
  tag: 'Onboarding',
  status: 'Prototype',
  summary: 'A collection-value tracker — sign-in, email verification and an empty portfolio worth opening.',
  lede: '<strong>Trove</strong> catalogues the sneakers, watches and records you already own, and tracks what the market says they\'re worth. Fourteen onboarding screens, built as a running iOS app.',
  blocks: [
    {
      t: 'p',
      x: 'Signing in is dark and the app is light, because one is a lobby and the other is a ledger. The whole sign-in sits in a sheet over the welcome screen, so closing it never feels like leaving; the code step counts down before it will resend, rather than letting four live codes pile up in one inbox; and the amber takes near-black text instead of white, which is the one place this system parts company with the usual dark-UI habit. Every failure has a screen of its own — an unfinished domain, a code that doesn\'t match, a network that drops mid-verification.',
    },
    ...
    { t: 'image', src: '/onboarding-assets/trove-screens/images/trove-02-verify.webp', alt: 'Trove code entry, verifying, success and the empty collection', caption: 'Entering, verifying, in, and the collection waiting to be filled.' },
