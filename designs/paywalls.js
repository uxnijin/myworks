...
BODY('paywalls', {
  blocks: [
    ...
    {
      t: 'p',
      x: 'Sleep sounds, so the opposite screen to a sale: nothing on it flashes, because a product you open at midnight can\'t be sold at you in the colours of a discount. There is exactly one decision, and it is two tiles rather than a list, and with only two prices, a list of two is a list pretending to be longer. The prices sit above the feature rows on purpose: on a screen this quiet the decision belongs above the fold and the argument for it below. The moon, the rings and the stars are drawn, and the star positions are written down rather than random so a re-capture is the same picture.',
    },
    {
      t: 'image',
