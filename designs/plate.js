...
BODY('plate', {
  blocks: [
    ...
    { t: 'p', x: 'The number in the biggest type is what is <em>left</em>, not what has been eaten, and that is the one you make the next decision with. Days you logged carry a dot, so the week reads as a habit rather than a calendar.' },
