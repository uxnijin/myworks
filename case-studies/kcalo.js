...
BODY('kcalo', {
  blocks: [
    ...
    { t: 'p', x: 'The hero card answers the only question that matters at a glance: how much is left today. And on open, it earns the glance — the card settles in, the ring draws itself to where the day stands, and the macro bars fill in turn. The load-in lives with the other clips in the motion strip further down; nothing moves that does not mean something.' },
    ...
    { t: 'p', x: 'The scan flow is the product: camera, a three-second analyzing state that says what it is doing, and an itemised result. The result arrives as a sheet over the day; the transition itself sits in the motion strip, exported straight from the keyframes.' },
    ...
    { t: 'p', x: 'All six clips were built as real Figma motion, keyframe by keyframe, and exported straight from the file: the hero card load-in, the result sheet arriving, the day-12 streak, the analyzing state, a toggle that overshoots a little, and a button that gives under the thumb and ripples once. Small enough to miss, which is the point.' },
    { t: 'hscroll', label: 'Motion clips', items: [
      { video: '/kcalo-assets/motion-hero.mp4' },
      { video: '/kcalo-assets/motion-sheet.mp4' },
      { video: '/kcalo-assets/motion-streak.mp4' },
      { video: '/kcalo-assets/motion-scan.mp4' },
      { video: '/kcalo-assets/motion-toggle.mp4' },
