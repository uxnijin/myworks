...
BODY('oppam', {
  blocks: [
    ...
    { t: 'p', x: 'It also has one of the highest suicide rates in the country. 30.6 for every 100,000 people in 2023, against a national average of 12.3. Third highest of any state or union territory.' },
    { t: 'p', x: 'And the National Mental Health Survey still puts the treatment gap at 84.5 percent. The best served state in the country, and most people who need help are not getting any.' },
    { t: 'image', src: '/oppam-assets/the-kerala.webp', alt: 'Kerala in three numbers: 1.2 psychiatrists per 100,000, an 84.5 percent national treatment gap, and 30.6 suicides per 100,000 in 2023 against a national 12.3', caption: 'The state with the best coverage in the country.' },
    { t: 'image', src: '/oppam-assets/the-gap.webp', alt: 'Psychiatrists per 100,000 people: Kerala 1.2, India 0.75, a workable minimum 3.0', caption: 'Leading India, and still under half of a workable minimum.' },
    ...
    { t: 'p', x: 'The category is neither empty nor bad. Wysa has reached eleven million lives across a hundred and five countries and sits at 4.8 stars. Amaha has served four and a half million users. YourDOST puts counsellors on text, audio and video. These are real products with real reach.' },
    ...
    { t: 'p', x: 'But look at where they all begin. Open each one and the first screen is a chatbot introducing itself, a pitch for your wellbeing, or a logo followed by a sign-up.' },
    { t: 'image', src: '/oppam-assets/the-starts.webp', alt: 'The first App Store screenshot of Wysa, Amaha and YourDOST', caption: 'The first thing each app shows you.' },
    { t: 'p', x: 'The ten minutes <em>before</em> a person decides to ask for help is nobody&rsquo;s screen.' },
    { t: 'p', x: 'Price is the other thing worth looking at, because most of this category was built for a different economy. BetterHelp runs 70 to 100 dollars a week, billed monthly. A subscription is a commitment, and a commitment is the exact thing somebody unsure is not ready to make.' },
    { t: 'image', src: '/oppam-assets/the-price.webp', alt: 'BetterHelp at 70 to 100 dollars a week beside Oppam at 1,000 rupees a session', caption: 'A subscription, against a price you pay once.' },
    { t: 'image', src: '/oppam-assets/the-category.webp', alt: 'Wysa, Amaha and YourDOST with their reach: 11 million lives across 105 countries, 4.5 million users, counsellors on text, audio and video', caption: 'Three of the biggest, and where each of them starts.' },
    { t: 'p', x: 'That is the gap this app is built into.' },

    { t: 'h2', x: 'What Oppam has today' },
    { t: 'p', x: 'Oppam is Kerala&rsquo;s first 24/7 online counselling platform, run out of Kozhikode. The site counts more than 50,000 therapy hours and a 4.8 rating on Google. Individual, couple and follow-up sessions, plus corporate and campus programmes, across the things people actually arrive with: anxiety, stress, depression, trauma, grief, anger, work burnout, parenting, queer-affirmative concerns.' },
    { t: 'image', src: '/oppam-assets/site-hero.webp', alt: 'The oppam.me homepage: a sunrise illustration, 24x7 online therapy, and a consult a therapist button', caption: 'oppam.me as it stands today.' },
    { t: 'image', src: '/oppam-assets/the-oppam.webp', alt: 'Oppam has raised 1.5 crore in seed funding led by Phoenix Angels and 90 lakh in an extended round, delivered over 50,000 therapy hours, and rates 4.8 on Google', caption: 'Money, clients and hours behind it.' },
    { t: 'p', x: 'It raised 1.5 crore in a seed round led by Phoenix Angels, then 90 lakh more in an extension. It runs Oppam Academy, training psychologists out of the Calicut office. This is a working company rather than a hypothetical one, and that decides what a redesign is allowed to be: something the people already using it would recognise on the first open.' },
    { t: 'p', x: 'And the website is already good. That is worth saying plainly, because it changes what the app is for.' },
    { t: 'image', src: '/oppam-assets/site-cards.webp', alt: 'Therapist cards on the website showing photo, credential, concern tags, a voice introduction player, languages, therapy hours, price per session and a book now button', caption: 'One card on the website, and everything it already carries.' },
    { t: 'p', x: 'Look at what a card already holds. Her photo and her credential. The concerns she takes. A voice introduction you can play before you decide. The languages she works in. The hours she has done. The price per session in rupees. When she is next free. One button to book her.' },
    { t: 'p', x: 'Nothing important is hidden, and none of it needs a phone call first. So the app is not here to rescue a broken website. Most of the good ideas in it started here, and it keeps them: a price on every card, a voice before the money, the language named up front.' },

    { t: 'h2', x: 'What an app can do that a page cannot' },
    { t: 'p', x: 'Three things, and they are the whole reason this project exists.' },
    { t: 'p', x: '<strong>Privacy.</strong> A browser keeps history. A tab can be read over a shoulder. A shared phone has no Face ID door, no cover in the app switcher, and no way to make a notification say nothing. That is the barrier the research keeps pointing at, and it is the one a website structurally cannot answer.' },
    { t: 'p', x: 'It is not a theoretical worry in this category either. In 2023 BetterHelp, the biggest name in online therapy, paid 7.8 million dollars to settle with the US Federal Trade Commission over sharing email addresses, IP addresses and the answers people gave to health questions with Facebook, Snapchat, Pinterest and Criteo, for advertising. Around 800,000 people were eligible for a refund.' },
    { t: 'image', src: '/oppam-assets/the-ftc.webp', alt: 'BetterHelp paid 7.8 million dollars to settle with the US Federal Trade Commission over sharing health answers with advertisers', caption: 'The exact thing this design is built to make impossible, already done at scale.' },
    { t: 'p', x: 'So privacy here is not a policy page. It is the reason the app holds everything on the device and asks for no account at all.' },
    { t: 'p', x: '<strong>The part before choosing.</strong> The website still opens onto a grid of therapists, which asks a person to evaluate strangers while anxious. An app can start from how somebody feels and bring three people forward with the reason for each.' },
    { t: 'p', x: '<strong>A reason to open it on a day you are not booking.</strong> A website&rsquo;s job ends at the booking. An app can hold a two minute breath, a page nobody else reads, a small win from last week. That is what keeps a person near help long enough to eventually ask for it.' },
    { t: 'p', x: 'So the app is not the website with a tab bar bolted on. It is the three parts the website was never going to hold.' },
    ...
    { t: 'image', src: '/oppam-assets/the-rules.webp', alt: 'Four rules: trust before identity, one loud action, visible not promised, and presence not performance', caption: 'Pinned above the desk for the rest of it.' },
