...
BODY('auto-dark-mode', {
  blocks: [
    ...
    { t: 'p', x: 'It does not invert anything. It looks at each colour and works out what that colour is <em>for</em> — a background, a card, a border, text, an icon, or a brand colour — then treats each one the way it should be treated.' },
    {
      t: 'list',
      items: [
