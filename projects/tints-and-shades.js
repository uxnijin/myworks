const PROJECT_TINTS_AND_SHADES = {
  ...
  lede: 'Pick a base color, get a mathematically uniform scale, push it straight into Figma variables, or export it as Tailwind config, CSS custom properties, or Style Dictionary JSON.',
  status: 'Open source',
  blocks: [
    {
      t: 'p',
