...
BODY('site-speed-test', {
  blocks: [
    ...
    { t: 'p', x: 'Look at its shape, not its length. A staircase, where each request starts only once the one above has finished, means you are paying a full round trip per step. A wide flat block is the same bytes loading all at once, and a completely different experience.' },
