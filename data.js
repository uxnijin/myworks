...
const HOME = {
  ...
  featuredProjects: ['network-tools', 'tasks-extension', 'figma-background-remover'],
  latestSlugs: [],
};
...
const PROJECTS = [
  ...
  {
    slug: 'network-tools',
    thumbUrl: '/images/thumbs/network-tools.webp',
    name: 'Network Tools',
    tag: 'Network',
    icon: 'globe',
    group: 'Network Tools',
    url: 'https://networktools.nijin.site/',
    summary: 'Speed test, site speed test, DNS checker and IP checker. Four tools on one site, built in the Carbon design style.',
    lede: 'The four network questions people actually ask, on one site: how fast is my connection, why is my page slow, can the world see my DNS change yet, and what does the internet think my IP means.',
    status: 'Live',
    body: '/projects/network-tools.js',
  },
  {
    slug: 'diecastkerala',
